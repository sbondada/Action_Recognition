...
def getTrajectories(filepath,startframe,endframe,trajectoylength,x,y,width,height):
    ...
    newfilesplit.insert(-1,'seq2_double')
    modfile=''
...
def displayTrajectories(filepath,trajectorylength,x,y,w,h):
    ...
    moddirstruct="/"+dirstruct[1]+'/'+dirstruct[2]+'/'+dirstruct[3]+'/'+dirstruct[4]+'/'+dirstruct[5]+'/'+dirstruct[6]+"/results/"+dirstruct[7]+'/'+dirstruct[9]+"/seq2_double/"+dirstruct[10]
