...
def computeBagOfWords(codefile,inputLocationList,binSize):
    ...
    for dt_location in inputLocationList:
        ...
        tempsavelocation+='seq2_bow_double/'       
...
if __name__=="__main__":
    inputLocationList=['/home/kaushal/Documents/projects/dense_trajectory_and_codebook/data/results/MSR2/boxing/seq2_double','/home/kaushal/Documents/projects/dense_trajectory_and_codebook/data/results/MSR2/handwaving/seq2_double','/home/kaushal/Documents/projects/dense_trajectory_and_codebook/data/results/MSR2/handclapping/seq2_double']
    computeBagOfWords('/home/kaushal/Documents/projects/dense_trajectory_and_codebook/data/results/codebook.double.pickle.txt',inputLocationList,100)
